...
public class HelpFragmentDialog extends DialogFragment implements View.OnClickListener{
    TextInputEditText inputText;
    TextView inputTextCounter;
    Button sendSupportRequest;
    private HelpFragmentDialog.Callback callback;

    public static HelpFragmentDialog newInstance() {
        return new HelpFragmentDialog();
    }

    public void setCallback(HelpFragmentDialog.Callback callback) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sendSupportRequest = view.findViewById(R.id.dialog_fragment_send);
        setSupportRequestBtn(view);
    ...
    private void setSupportRequestBtn(View view) {
        sendSupportRequest.setOnClickListener(new View.OnClickListener() {
            @Override
